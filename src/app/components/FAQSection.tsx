...
export default function FAQSection() {
  return (
    <section className="relative py-16 bg-gradient-to-br from-blue-900 to-blue-950 overflow-hidden px-6">
      {/* Background Image */}
      ...
      <div className="relative mr-10 z-10">
        <h2 className="text-2xl font-bold text-center m-10 text-white">Questions and answers for common ML queries</h2>
      ...
      <div className="absolute left-1/4 top-1/2 transform -translate-y-1/2 z-5 opacity-80">
        <div className="w-64 h-64 rounded-full border border-blue-400 bg-blue-800 bg-opacity-20 flex items-center justify-center relative overflow-hidden">
          {/* Inner cylinder content - data visualization */}
        ...
        {/* Binary code circle beneath */}
        <div className="absolute -bottom-16 left-1/2 transform -translate-x-1/2 w-96 h-24 rounded-full border border-blue-400 bg-blue-900 bg-opacity-20 flex items-center justify-center">
      ...
      <div className="hidden md:block absolute left-1/4 bottom-16 z-10">
        {/* This would be better with actual SVG figures but using divs as placeholders */}
