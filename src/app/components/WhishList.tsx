        ...
        <div className="w-full mt-8 md:mt-0 mx-auto md:mx-0 md:mr-4 lg:mr-10 max-w-md bg-transparent">
          ...
          <form onSubmit={handleSubmit} className="space-y-3 md:space-y-4">
            ...
            <button
              ...
              className={`w-full md:w-auto bg-indigo-900 text-white px-4 py-2 sm:py-3 rounded-full hover:bg-blue-600 transition-colors duration-300 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 ${
